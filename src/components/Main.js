...
function Main() {
    return (
      <>
          <div className='p-y-axis-0'>
          <h1 className='text-start text-4xl p-5 font-bold'>Best of Elactronics</h1>
        <div className=' flex overflow-x-auto p-4 overflow-hidden  whitespace-nowrap gap-4 justify-evenly'>
